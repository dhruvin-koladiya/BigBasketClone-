//
//  Fruits&VegetablesViewController.swift
//  PageUI
//
//  Created by ABC on 16/03/23.
//
...
class FruitsVegetablesViewController: UIViewController {
    ...
    var FruitsVegetablesTableViewCell = UITableViewCell()
    var cell: FruitsVegetablesTableViewCell!
    ...
    // MARK: - Get FruitsVegetablesViewController Page Details
    private func configureTableView() {
        tableView.register(UINib(nibName: "FruitsVegetablesTableViewCell", bundle: nil), forCellReuseIdentifier: "cell")
    }
    ...
    private func loadCategory() {
        ...
        let three: CategoryCell = CategoryCell(image: UIImage(named: "three")!, name1: "Cauliflower", name2: "", popupButton: "Har Din Sasta!", addButton: "Add", p1: "₹20.5", p2: "₹33.55", nameLabel: "FRESHO")
        ...
        let six: CategoryCell = CategoryCell(image: UIImage(named: "six")!, name1: "Onion", name2: "(Loose", popupButton: "Har Din Sasta!", addButton: "Add", p1: "₹21.50", p2: "₹32.51", nameLabel: "FRESHO")
...
// MARK: - TableViewDelegate And TableViewDatasource Method For FruitsVegetablesViewController
extension FruitsVegetablesViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! FruitsVegetablesTableViewCell
        ...
        cell.PricePopButton.addTarget(self, action: #selector(priceButtonTapped(_:)), for: .touchUpInside)
    ...
    func priceButtonTapped(_ sender: UIButton) {
        ...
        cell = tableView.cellForRow(at: indexPath) as? FruitsVegetablesTableViewCell
